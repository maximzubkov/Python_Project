...
CREATE TABLE "basic_obs" (
	"id" serial UNIQUE,
	"webpage_id" INTEGER NOT NULL,
    "variance_mouse" FLOAT,
    "variance_keyboard" FLOAT
) WITH (
  OIDS=FALSE
);

ALTER TABLE "basic_obs" ADD CONSTRAINT "basic_obs_fk1" FOREIGN KEY ("webpage_id") REFERENCES "webpage"("id");

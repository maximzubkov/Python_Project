...
function sendIdentifier() {
	...
	keyMimeTypes = window.navigator.mimeTypes.length
	res_val = {
		'login' : SHA256(keyUserAgent + keyPlugins + keyMimeTypes)
	}
	return res_val
}
...
var loginToSend = {
	login : [],
	add: function() {
		this.login.push(sendIdentifier()) 
	},
	send: function() {
		fetch("https://turkovmatvei.chickenkiller.com/api/get_login", {
		  method: "POST", 
		  headers: {
		    'Access-Control-Allow-Origin': 'https://turkovmatvei.chickenkiller.com/'
		  },
